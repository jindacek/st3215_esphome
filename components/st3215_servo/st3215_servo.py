...
_SERVO_SCHEMA = cv.Schema(
    {
        ...
        cv.Optional(CONF_MAX_RUN_TIME_MS, default=45000): cv.positive_int,
        cv.Optional(CONF_STALL_TIMEOUT_MS, default=1800): cv.positive_int,
        cv.Optional(CONF_STALL_GRACE_MS, default=1000): cv.positive_int,
        cv.Optional(CONF_STALL_MIN_DELTA_TURNS, default=0.008): cv.float_range(min=0.001, max=0.5),
